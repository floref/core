 ...
 */
public class BaseSingular<P, F, T, U, V, W, X, Y, Z> extends FlowInstructionImpl<F> implements
    ToSingular<BaseSingular<P, F, T, U, V, W, X, Y, Z>, T, U, V, W, X, Y, Z>
     {

  public BaseSingular() {
  }
  public BaseSingular(FlowInstruction instruction) {
